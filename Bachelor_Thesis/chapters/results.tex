...
were met in the final build; the populated dashboard (Figure~\ref{fig:res_dashboard}) illustrates this.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/res_dashboard_populated.jpg}
...
New users fill out a registration form (Figure~\ref{fig:res_signup}) with validated identity fields and optional profile fields.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/res_signup.jpg}
...
redirects unauthenticated users to the login page (Figure~\ref{fig:res_login}) immediately, without a round-trip to
the server.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/res_login.jpg}
...
The new-task editor (Figure~\ref{fig:res_task_editor}) exposes all required and optional fields with the Smart Auto Fill panel at the top.
...
The Smart Auto Fill feature (Figure~\ref{fig:res_ai_smart_autofill}) populates fields from a natural-language prompt via the Mistral OCR model.
...
This view is shown in Figure~\ref{fig:res_default_view} and proved most useful for daily triage.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/res_default_view.jpg}
...
macOS~14 (Safari and Tauri), as shown in Figure~\ref{fig:res_kanban_view}.
...
\textbf{Table View.}
Tasks are displayed in a data-grid layout (Figure~\ref{fig:res_table_view}) with sortable columns for title, status,
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/res_table_view.jpg}
...
During testing the Gantt view (Figure~\ref{fig:res_gantt_view}) was found useful for identifying workload clusters across
months.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/res_gantt_view.jpg}
...
lanes, as illustrated in Figure~\ref{fig:res_calendar_view}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/res_calendar_view.jpg}
...
The AI chatbot was tested in all three operational modes (Figure~\ref{fig:res_ai_chatbot}).

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/res_ai_chatbot_empty.jpg}
...
formatted the code blocks with monospace styling and language labels, as shown in Figure~\ref{fig:res_ai_coder}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/res_ai_coder.jpg}
...
level by rendering events in adjacent lanes, as shown in Figure~\ref{fig:res_calendar_events}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/res_calendar_events.jpg}
...
increments without a page reload (Figure~\ref{fig:res_notifications}).

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/res_notifications.jpg}
...
to \texttt{AppUser} immediately and reflected on the settings page (Figure~\ref{fig:res_settings}) after save.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/res_settings.jpg}
