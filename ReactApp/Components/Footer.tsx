...
export default function Footer() {
  ...
  return (
    <footer style={{ background: "#F7F7F7", borderTop: "1px solid #DDDDDD", fontFamily: "Roboto, sans-serif", marginTop: 32 }}>
      {/* Bottom bar */}
      <div
        style={{
          maxWidth: 1280,
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
          ...
          <a href="https://twitter.com" target="_blank" rel="noreferrer" aria-label="X" style={{ color: "#222222", display: "flex" }}>
