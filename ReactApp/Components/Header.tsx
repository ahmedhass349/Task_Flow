      ...
      <div className="flex-1 max-w-2xl">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-20 py-2 border border-gray-700 rounded-lg bg-gray-900 text-white placeholder:text-gray-500 focus:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <kbd className="absolute right-3 top-1/2 -translate-y-1/2 px-2 py-0.5 text-xs font-semibold text-gray-400 bg-gray-800 border border-gray-700 rounded">
            Ctrl K
          </kbd>
        </div>
      </div>
